...
//
//				Single Thread Model
//				One thread handles multiple 
//				simultaneous connections using
...
// and HTTPSERV informational notifications
//
						  ...
						  LPARAM lParam) 
{
	switch (uMsg) 
	{
		...
		// 
		// Pass async messages to HTTPSERV
		//
		case UM_ASYNC:  
